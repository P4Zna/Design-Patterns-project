...
public class User implements Person,MovieObserver {
  ...
  @Override
    ...
    public void update(Movie movie) {
        if (movie.isVerified()) {
            System.out.println(name + ": Movie '" + movie.getTitle() + "' is now available.");
        } else {
            System.out.println(name + ": Movie '" + movie.getTitle() + "' is not available yet.");
        }
    }
}
