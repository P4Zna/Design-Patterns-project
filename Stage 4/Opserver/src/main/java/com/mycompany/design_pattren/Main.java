...
public class Main {
    ...
    public static void main(String arr[]) {
        ...
        //Observer
        Movie movie1 = new Movie("Lovetoday", 2022, "Tamil", "Love");
        Movie movie2 = new Movie("Inception", 2022, "Tamil", "Action");
        Movie movie3 = new Movie("Devil", 2012, "English", "Horror");
        Movie movie4 = new Movie("Frozen", 2020, "English", "Sci-Fi");
        Movie movie5 = new Movie("Kathi", 2017, "Tamil", "Action");
        Movie movie6 = new Movie("Friends", 2014, "English", "Comedy");
