...
private static void login() {
    ...
    // Modify the addMovie method in the Main class
private static void addMovie(MovieComponent component) {
    if (component instanceof Movie) {
        movies.add((Movie) component);
    } else {
        // Handle if the component is not a Movie
        System.out.println("Error: Attempted to add a non-Movie component.");
    }
}
